"use client";
import MenusIcon from "assets/icons/menusIcon.svg";
...
export const Sidebar = ({ isAuth }: { isAuth: boolean }) => {
  return (
    isAuth && (
      <div className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform fixed lg:sticky h-[100vh] top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
        <div className="px-6">
          <span
